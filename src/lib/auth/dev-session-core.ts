...
export function decodeDevSession(
  ...
  try {
    ...
    return {
      ...
      accountStatus: "active", displayName: null, policyIdentity: null, termsVersion: null, termsAcceptedAt: null, privacyNoticeVersion: null, privacyNoticeAcknowledgedAt: null,
    };
  } catch {
    return null;
  }
