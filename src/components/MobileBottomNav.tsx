...
export function MobileBottomNav({ user }: { user: AuthUser | null }) {
  return (
    <nav aria-label="모바일 메뉴" className="fixed inset-x-0 bottom-0 z-30 border-t border-border bg-background/95 pb-[env(safe-area-inset-bottom)] backdrop-blur sm:hidden">
